...
namespace GameEngine.Test
{
    public class GameStateShould : IClassFixture<GameStateFixture>
    {
        ...
        public void DamageAllPlayerWhenEarthquake()
        {
            ...
            var expectedHelathAfterEarthquake = player1.Health - GameState.EarthquakeDamage;

            _gameStateFixture.State.Earthquake();

            Assert.Equal(expectedHelathAfterEarthquake, player1.Health);
            Assert.Equal(expectedHelathAfterEarthquake, player2.Health);
        }
